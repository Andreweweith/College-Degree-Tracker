...
public class StudentReportWindow {
	...
	// PANE FOR THE WINDOW ***
	private BorderPane studentReportWindow;
	...
	public StudentReportWindow() {
		
		// Window (BorderPane)
		studentReportWindow = new BorderPane();
		...
		studentReportWindow.setCenter(reportPane);
	}
	
	// Retrieve window for display
	public BorderPane getStudentReportWindow() {
	...
	public void setReportStudentInfo(String firstName, String lastName,
